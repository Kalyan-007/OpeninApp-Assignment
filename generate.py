...
def create_seed(filename,
    ...
    cut_index = tf.compat.v1.cond(tf.compat.v1.size(quantized) < tf.compat.v1.constant(window_size),
                        lambda: tf.compat.v1.size(quantized),
                        lambda: tf.compat.v1.constant(window_size))
...
def main():
    ...
    samples = tf.compat.v1.placeholder(tf.compat.v1.int32)
